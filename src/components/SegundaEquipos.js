...
const SegundaEquipos = () => {
  ...
  return (
    <div>
      <h1>Equipos categoría Segunda</h1>
      <br></br>
      <div className='container'>
      <div className='row'>
        <div className='col'>
          <div className="d-grid gap-2">
            <Link to="/crearsegunda" className='btn btn-secondary mt-2 mb-2'>Crear nuevo equipo</Link>    
          </div>
            ...
            <tbody>
              { equipos.map( (equipo) => (
                <tr key={equipo.id}>
                  ...
                  <td>
                    <Link to={`/editsegunda/${equipo.id}`} className="btn btn-light"><i className="fa-solid fa-pencil"></i></Link>
