...
const deleteProduct = async (id) => {
    const productDoc = doc(db, "jornadasmaxima", id)
...
useEffect(() => {
  ...
  return (
    <div>
    <h1>Jornadas categoría Maxima</h1>
    <br />
    <div className='container'>
      <div className='row'>
        <div className='col'>
          <div className="d-grid gap-2">
            <Link to="/crearJornadaMax" className='btn btn-secondary mt-2 mb-2'>Crear nueva Jornada</Link>
          </div>
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="card-actions">
                      <Link to={`/editJornadaMax/${jornada.id}`} className="btn btn-light">
