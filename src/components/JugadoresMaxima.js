      ...
      <div className='row'>
        <div className='col'>
          <div className="d-grid gap-2">
            <Link to="/crearjugadorMax" className='btn btn-secondary mt-2 mb-2'>Crear nuevo jugador</Link>    
          </div>
            ...
            <tbody>
              { equipos.map( (equipo) => (
                <tr key={equipo.id}>
                  ...
                  <td>
                    <Link to={`/editJugadorMax/${equipo.id}`} className="btn btn-light"><i className="fa-solid fa-pencil"></i></Link>
