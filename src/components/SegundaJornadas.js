...
const deleteProduct = async (id) => {
    const productDoc = doc(db, "jornadasSegunda", id)
      ...
      <div className='row'>
        <div className='col'>
          <div className="d-grid gap-2">
            <Link to="/crearJornadaSegunda" className='btn btn-secondary mt-2 mb-2'>Crear nueva Jornada</Link>
          </div>
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="card-actions">
                      <Link to={`/editJornadaSegunda/${jornada.id}`} className="btn btn-light">
