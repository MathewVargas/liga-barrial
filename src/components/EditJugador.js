...
const Edit = () => {
    ...
    const update = async (e) => {
        ...
        if(file!=null){
            ...
            const data = {nombre: nombre, foto: result, apellido: apellido, numero: numero, categoria: 'maxima', goles: 0, equipo: equipo }
            ...
            const product = doc(db, "jugadores", id)
            const data = {nombre: nombre, foto: foto, apellido: apellido, numero: numero, categoria: 'maxima', goles: 0, equipo: equipo }
            await updateDoc(product, data)
            navigate('/maxim')
        }
    ...
    const q1 = query(equiposCollection, where("categoria", "==", "maxima"));
