...
const Dashboard = () => {
  ...
  return (
    <div>
      <h1>Jugadores categoría Maxima</h1>
      <div className='container'>
      <div className='row'>
        <div className='col'>
          <div className="d-grid gap-2">
            <Link to="/crearjugadorPrim" className='btn btn-secondary mt-2 mb-2'>Crear nuevo jugador</Link>    
          </div>
            ...
            <tbody>
              { equipos.map( (equipo) => (
                <tr key={equipo.id}>
                  ...
                  <td>
                    <Link to={`/editJugadorPrimera/${equipo.id}`} className="btn btn-light"><i className="fa-solid fa-pencil"></i></Link>
